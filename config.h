...
//static const int thumb_sizes[] = { 32, 64, 96, 128, 300, 376, 412 }; //265, 160, 260 };
static const int thumb_sizes[] = { 32, 64, 96, 128, 286, 376, 412 }; //265, 160, 260 };
...
//	{ 0,	        XK_comma,         g_prefix_external,    None },
	{ 0,            XK_grave,         g_reload_image,       None },
